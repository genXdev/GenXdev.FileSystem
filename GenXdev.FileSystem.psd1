...
FileList = '.gitignore', 'GenXdev.FileSystem.csproj', 
               'GenXdev.FileSystem.format.ps1xml', 'GenXdev.FileSystem.psd1', 
               'GenXdev.FileSystem.psm1', 'LICENSE', 'License.txt', 'powershell.jpg', 
               'README.md', 'lib\GenXdev.FileSystem.deps.json', 
