...
FunctionsToExport = 'Confirm-InstallationConsent', 'EnsurePester', 'Expand-Path', 
               ...
               'ResolveInputObjectFileNames', 'Set-FoundLocation', 
               'Set-LocationParent', 'Set-LocationParent2', 'Set-LocationParent3', 
               'Set-LocationParent4', 'Set-LocationParent5', 'Start-RoboCopy', 
               'WriteFileOutput', 'WriteJsonAtomic'

# Cmdlets to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no cmdlets to export.
CmdletsToExport = 'Copy-IdenticalParamValues', 'Find-Item'
...
AliasesToExport = '..', '...', '....', '.....', '......', 'ep', 'fasti', 'fdf', 'fhx', 'gcb', 'gin', 
               'gtz', 'l', 'lcd', 'rc', 'recycle', 'rip', 'rmf', 'scb', 'sdel', 'stz', 'xc'
...
FileList = 'GenXdev.FileSystem.csproj', 'GenXdev.FileSystem.format.ps1xml', 
               ...
               'Functions\GenXdev.FileSystem\Set-LocationParent2.ps1', 
               'Functions\GenXdev.FileSystem\Set-LocationParent3.ps1', 
               'Functions\GenXdev.FileSystem\Set-LocationParent4.ps1', 
               'Functions\GenXdev.FileSystem\Set-LocationParent5.ps1', 
